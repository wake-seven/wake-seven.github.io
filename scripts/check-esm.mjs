...
import { createMessageCatalog } from '../src/data/messages-data.mjs';
...
import { createMessagePresenter, createClearMessageModel } from '../src/ui/messages-ui.mjs';
...
const detachEvents = events.attach();
assert.equal(events.size, 1);
detachEvents();
assert.equal(events.size, 0);
