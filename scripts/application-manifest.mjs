...
export const applicationModuleFiles = [
  ...
  'ui/board-animation.js', 'ui/board-geometry.js', 'ui/board-ui.js', 'ui/board-render.js', 'commands/board-commands.js', 'commands/progression-commands-legacy.js', 'commands/settings-commands.js',
