...
export const applicationModuleFiles = [
  ...
  'ui/board-animation.js', 'ui/board-geometry.js', 'ui/board-interaction.js', 'ui/tutorial-animation.js', 'ui/board-ui.js', 'ui/board-render.js', 'ui/ui-context.js', 'commands/board-commands.js', 'commands/progression-command-entry.js', 'commands/settings-commands.js', 'commands/progression-commands.js', 'commands/speed-commands.js', 'commands/speed-record-commands.js', 'commands/tutorial-commands.js',
  'ui/quiz.js', 'ui/clear-flow.js', 'ui/message.js', 'ui/progression-render.js', 'ui/progression-dialogs.js',
  'ui/master-dialog.js', 'ui/progression-stage-picker.js', 'ui/progression-ui.js', 'ui/progression-mode-controls.js', 'ui/progression-hud.js', 'ui/progression-quiz.js', 'ui/progression-commands.js', 'ui/progression-roadmap.js', 'ui/progression-hints.js', 'ui/progression-clear-flow.js', 'ui/progression-navigation.js', 'ui/rank.js', 'ui/svg.js', 'ui/render.js',
