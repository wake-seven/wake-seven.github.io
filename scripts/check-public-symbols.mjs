...
const knownScopeCandidates = new Set('arm awakening begin canEnter clearFlow commit definitions intermediate isClearShown json mastery on openReview pathInfo pause pauseClock persist query queryAll remove renderReview reset satoriIntro secondLapIntro setClearShown setJson setMode speedComplete speedIntro speedTrialFailed speedUnlocked startClock uiPolicy update'.split(' '));
