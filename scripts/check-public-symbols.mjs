...
const knownScopeCandidates = new Set('advance arm awakening back begin canEnter clearFlow commit complete definitions intermediate isClearShown json mastery on openPicker openReview pathInfo pause pauseClock persist query queryAll remove render renderReview restore reset satoriIntro secondLapIntro setClearShown setJson setMode speedComplete speedIntro speedTrialFailed speedUnlocked startClock uiPolicy update'.split(' '));
