...
const knownScopeCandidates = new Set('arm awakening back begin canEnter clearFlow commit definitions intermediate isClearShown json mastery on openReview pathInfo pause pauseClock persist query queryAll remove render renderReview restore reset satoriIntro secondLapIntro setClearShown setJson setMode speedComplete speedIntro speedTrialFailed speedUnlocked startClock uiPolicy update'.split(' '));
