...
const appModuleFiles = ['core-data.js', 'runtime.js', 'speed-runtime.js', 'board-animation.js', 'board-ui.js', 'quiz-ui.js', 'message-ui.js', 'progression-ui.js', 'app-events.js'];
...
const moduleLabels = ['基礎データ', '実行状態', 'スピードランランタイム', '盤面アニメーション補助', '盤面UI', 'クイズUI', 'メッセージUI', '進行UI', 'イベントと起動'];
