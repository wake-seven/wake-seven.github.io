...
const appModuleFiles = ['data-clear-content.js', 'core-data.js', 'data-ui-text.js', 'data-board-quiz.js', 'data-assets.js', 'runtime.js', 'speed-runtime.js', 'board-animation.js', 'board-ui.js', 'quiz-ui.js', 'clear-flow.js', 'message-ui.js', 'progression-render.js', 'progression-ui.js', 'app-events.js'];
...
const moduleLabels = ['クリア後メッセージデータ', '基礎データ', '多言語UIテキスト', '盤面クイズデータ', '固定挿絵・SVGデータ', '実行状態', 'スピードランランタイム', '盤面アニメーション補助', '盤面UI', 'クイズUI', 'クリアフロー', 'メッセージUI', '進行表示', '進行UI', 'イベントと起動'];
