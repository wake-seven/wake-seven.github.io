...
const appModuleFiles = ['core-data.js', 'runtime.js', 'board-ui.js', 'message-ui.js', 'progression-ui.js', 'app-events.js'];
...
const moduleLabels = ['基礎データ', '実行状態', '盤面UI', 'メッセージUI', '進行UI', 'イベントと起動'];
