...
| OPEN-002 | Partly decided (2026-09-18); P8 configuration and layout parity are approved | P8 for remaining decoration boundary / Project owner | Match game-bearing geometry, interaction layout, and the shared placement of header, course identity, board, HUD, controls, and dialogs. Preserve explicitly accepted rebuild-only presentations. Permit browser font rasterization and non-functional shadow/antialias variance. Record same-state PC/phone observations in `P8_LAYOUT_COMPARISON.md`; do not call an uninspected row matched. | P8a comparison and corrections; P8b–P8d own their screen-specific content |
