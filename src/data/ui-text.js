...
const UI_TEXT={
  ja:{
    ...
    applicationWelcomeText:'そろえる3枚を見つけて、回す場所を自分で考えよう',
  ...
  en:{
    ...
    applicationWelcomeText:'Find the three daruma to align, then work out which bar to turn.',
  ...
  zh:{
    ...
    applicationWelcomeText:'找出要对齐的3个不倒翁，再自己思考该转动哪根横杆。',
  ...
  ko:{
    ...
    applicationWelcomeText:'맞춰야 할 다루마 3개를 찾고, 어느 막대를 돌릴지 스스로 생각해 보세요.',
