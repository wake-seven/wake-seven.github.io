...
function resetStoredProgress({resetIntro=false,showIntro=false,preserveRewards=false}={}){
  ...
  fourthCheckUsage={};
  try{
    storage.remove('wake7-cleared');
    storage.remove('wake7-extra-cleared');
    ...
    if(!preserveRewards){
      ...
      storage.remove('wake7-board-theme');
      storage.remove('wake7-board-layout');
      storage.remove('wake7-board-theme-chosen');
