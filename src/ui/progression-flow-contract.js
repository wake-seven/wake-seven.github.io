...
const PROGRESSION_FLOW_CONTRACT=Object.freeze([
  ...
  {id:'rank-reward',mode:'campaign|speed',from:'clear-dialog|speed-finished',event:'称号条件達成',entry:'showRankDialog',persist:'称号・報酬・解放状態',cancel:'closeRankDialog',to:'rank-dialog|next-stage-dialog'},
  ...
  {id:'reload-speed',mode:'speed',from:'page-load',event:'speed sessionを検出',entry:'restoreActiveSession→restoreSpeedSession',persist:'speed sessionを維持',cancel:'一時停止状態へ退避',to:'speed-pause-dialog|playing'}
]);
