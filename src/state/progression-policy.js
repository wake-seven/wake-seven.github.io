...
(function attachWakeSevenProgression(global) {
  ...
  const SPEED_BLUEPRINTS = Object.freeze([
    ...
    {id:'mastery15',visible:true,labelKey:'speedIntermediateLabel',introKey:'speedIntermediateIntro',jaLabel:'十八番',order:'shuffle',source:'training',total:'trainingExam',unlockKey:'speedIntermediate',showsRemaining:true,allowsUndo:true,trial:'intermediate'},
    {id:'mastery24',visible:true,labelKey:'speedMasteryLabel',introKey:'speedMasteryIntro',jaLabel:'二十七番',order:'sample',source:'satori',total:27,unlockKey:'speedMastery',showsRemaining:false,allowsUndo:true,trial:'mastery'},
